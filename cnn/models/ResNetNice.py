...
class BasicBlock(Block):
    def __init__(self, bitwidths, in_planes, out_planes, kernel_size, stride, input_size, prevLayer):
        ...
        self.block1 = MixedLayer(out_planes,
                                 createMixedConvWithReLU(bitwidths[0] if isinstance(bitwidths[0], list) else bitwidths,
        ...
        if in_planes != out_planes:
            ...
            self.downsample = MixedLayer(out_planes,
                                         createMixedConv(downsampleBitwidth, in_planes, [1], stride1, input_size[0],
                                                         prevLayer))
            bitwidthIdx += 1

        self.block2 = MixedLayer(out_planes,
                                 createMixedConvWithReLU(
                                     bitwidths[bitwidthIdx] if isinstance(bitwidths[0], list) else bitwidths,
                                     out_planes,
...
class ResNet(BaseNet):
    ...
    def buildStateDictMap(self, chckpntDict):
        ...
        layersNumberMap = [(1, 0, 1), (1, 1, 2), (2, 1, 4), (3, 1, 6), (4, 1, 8)]
        ...
        downsampleLayersMap = [(2, 0, 3), (3, 0, 5), (4, 0, 7)]
