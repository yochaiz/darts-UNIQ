...
commands = [
    [executable, './train_search.py',
     '--data', '../data/', '--batch_size', '250', '--arch_learning_rate', '0.1', '--lmbda', '0', '--dataset', 'cifar10',
     '--bitwidth', '3', '--baselineBits', '3', '--epochs', '5', '--alphas_data_parts', '4',
     '--model', 'resnet', '--learning_rate', '0.01', '--nCopies', '1', '--train_portion', '1.0', '--gpu', '0',
     '--grad_estimator', 'layer_same_path', '--alphas_regime', 'optimal_model', '--workers', '2', '--nSamples', '300',
     '--pre_trained', '../pre_trained/cifar10/train_portion_1.0/[(32, 32)],[resnet]/train/model.updated_stats.pth.tar'
     ]
    # ,
